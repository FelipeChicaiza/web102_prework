...
unfundedGamesElement.innerHTML = displayStr;
...
runnerUpElement.innerHTML = `${runnerUp.name} - $${runnerUp.pledged.toLocaleString()}`;
secondGameContainer.appendChild(runnerUpElement);

// Personal Challenge

//implementing the search funtion so you can seach for games inside of the games displayed
